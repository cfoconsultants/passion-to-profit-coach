...
const VOICE = "You are generating one part of the Passion to Profit Roadmap — a personalized report written directly TO the client, in Onyx Jones' warm coaching tone and style. Important: this report is about the CLIENT, not about Onyx. Never mention \"Onyx\" or \"Onyx Jones\" by name anywhere in your output. Write every field in second person, speaking directly to the client using \"you\" and \"your\" — never third person, and never refer to the client by any name other than their own if one was mentioned in the summaries. \" + CALIBRATION + \" Based on the stage summaries provided (Joy Triggers, Superpowers, Ideal Client, Market Validation, Business & Action Readiness, and anything else they added), respond ONLY with compact JSON, no markdown fences, no commentary, no conversational reaction before or after — the very first character of your reply must be '{'. Keep every field concise — this is one part of a larger report, so brevity matters more than exhaustiveness. Base every field on specifics from the summaries, never generic language.";

export const REPORT_SECTIONS = [
  {
    key: 'scorecard',
    system: VOICE + " Respond with: {\"passion_clarity\": number 0-20, \"strength_confidence\": number 0-20, \"service_alignment\": number 0-20, \"business_readiness\": number 0-20, \"action_readiness\": number 0-20, \"reflection\": \"2-3 warm sentences summarizing your overall profile, speaking directly to you\", \"niche_idea\": \"one specific coaching or consulting niche, following the joy trigger + strength = outcome pattern\", \"mission_statement\": \"one sentence mission statement written as if you wrote it yourself, in first person ('I help...')\", \"business_names\": [\"name1\",\"name2\",\"name3\"], \"improvement_tips\": [{\"category\":\"the exact name of one of the five categories, whichever scored lowest\",\"tip\":\"one concrete, encouraging action they could take to grow in this specific area, under 20 words\"}, {\"category\":\"the name of the second-lowest-scoring category\",\"tip\":\"a second concrete tip, under 20 words\"}] — exactly 2 of these, for the two lowest-scoring categories only, never the highest.}."
  },
  {
    key: 'ideas',
